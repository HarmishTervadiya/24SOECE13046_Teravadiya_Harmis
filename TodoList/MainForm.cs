...
namespace ToDoList
{
    public partial class MainForm : Form
    {
        ...
        private void TasksListView_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
        {
            ...
            {
                // Corrected bounds calculation for icons
                int iconSize = 20;
                int y = e.Bounds.Top + (e.Bounds.Height - iconSize) / 2; // Center vertically
        ...
        private void TasksListView_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (subItemIndex == 0) // Clicked on checkbox column
            {
                ToggleTaskCompletion(item);
            }
            else if (subItemIndex == 5) // Clicked on Actions column
            {
                int iconSize = 20;
