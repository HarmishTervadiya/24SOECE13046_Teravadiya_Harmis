...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:LinkButton ID="Home" runat="server" Text="Home">LinkButton</asp:LinkButton>
&nbsp;&nbsp;&nbsp;
            <asp:LinkButton ID="New" runat="server" Text="New Application">LinkButton</asp:LinkButton>
&nbsp;&nbsp;
            <asp:LinkButton ID="Update" runat="server" Text="Update Application">LinkButton</asp:LinkButton>
&nbsp;&nbsp;
            <asp:LinkButton ID="Remove" runat="server" Text="Remove Application">LinkButton</asp:LinkButton>
&nbsp;
            <asp:LinkButton ID="View" runat="server" Text="View All">LinkButton</asp:LinkButton>
        </div>
        <br />
        <hr />
